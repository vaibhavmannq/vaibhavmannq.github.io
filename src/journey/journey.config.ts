...
/**
 * Moonsink Shore's scroll length in screen heights. It was 3, then 2.4 when the owner asked for a
 * little shorter; 2.7 after they asked for "just a bit slow" once the scroll felt right (2026-09-14).
 */
export const MOONSINK_LENGTH = 2.7;
